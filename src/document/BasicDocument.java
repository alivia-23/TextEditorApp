...
public class BasicDocument extends Document 
{
	...
	{
		// use regexs to calculate the number of syllables and the other
		// that finds words using a loop.  The regex solution is commented 
		// out here at the top.

		/* solution using regex's.  Uncoment here to run it*/
		/*
		...
		*/
		...
		// solution that does NOT use regexs to find syllables 
