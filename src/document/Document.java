...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		for (int i = 0; i < cArray.length; i++) {
			//if the character is e and last one in the cArray and is the single e at the end of the word
			// then we decrement numSyllables count as it not a syllable
		...
		System.out.println( "found numSyllables " + numSyllables);
	    return numSyllables;
	}
